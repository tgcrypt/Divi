	...
	function get_fields() {
		$fields = array(
			...
			'video_url' => array(
				...
				'type'               => 'upload',
				'option_category'    => 'basic_option',
				'description'        => esc_html__( 'If defined, this video will appear to the left of your slide text. Type in the URL to the video you would like to display. Leave blank for a text-only slide.', 'et_builder' ),
				'data_type'          => 'video',
